...
def delete_contact(data_contact,name_data_list: str="data.csv"):
    """ принимает название файла и данные для поиска контакта для удаления, вызывает функцию поиска по имени или фамилии, удаляет контакт если он найден
    Arguments:
    ...
    if id_delete_contact>0:                                         #защита от удаления оглавления - 0 строка с оглавлением
        ...
        print(f'Вы уверены что хотите удалить {delete_contact_item}? Y/N')
